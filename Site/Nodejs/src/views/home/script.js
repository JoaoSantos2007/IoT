      ...
      if('settings' in obj_name){
          switch(types){
            case 'light':
              ...
              type_light(div_contents,key,valor,names,types,deviceId)
              break
            case 'tv':
              type_tv(div_contents,key,names,types,deviceId)
              break
            case 'air':
              type_air(div_contents,key,names,types,deviceId)
              break
        }
      }else{
...
function type_light(div,key,valor,name,type,deviceId){
  ...
  btn.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','btn')`)
...
function type_tv(div,key,name,type,deviceId){
  let section = window.document.createElement('section')
  ...
  figure_power.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#power')`)
  ...
  figure_source.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#source')`)
  ...
  figure_menu.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#menu')`)
  ...
  img_up_channel.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#up_channel')`)
  ...
  img_down_channel.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#down_channel')`)
  ...
  img_up_volume.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#up_volume')`)
  ...
  img_down_volume.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#down_volume')`)
...
function type_air(div,key,valor,name,type,deviceId){
  let section = window.document.createElement('section')
  ...
  figure_invert.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#invert')`)
  //Imagem Time
  ...
  figure_time.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#time')`)
  ...
  figure_sleep.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#sleep')`)
  ...
  figure_swing.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#swing')`)
  ...
  img_up_temp.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#up_temp')`)
  ...
  img_down_temp.setAttribute('onclick',`active('${key}','${type}','${name}','${deviceId}','#down_temp')`)
...
function active(id,type,name,deviceId,tag_name){
  ...
  db.collection("events").doc().set(docData)
}
