...
ul.innerHTML += `<li id="add"><a  href="/Site/createregisto/create.html"><img src="/Site/images/add.png" alt="add"></a></li>`
ul.innerHTML += `<li id="user"><a href="/Site/user/user.html"><img src="/Site/images/user.png" alt="user"></a></li>`
